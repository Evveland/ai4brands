...
export function BadgesPage() {
  const { go } = useNav();
  const groups = [
    { icon: "🚀", title: "Startup Badges", tagline: "Para equipos que quieren ganarse acceso y visibilidad.",
      items: [
        { title: "Applicant", sub: "Registro validado en la base de datos", icon: "✅" },
        { title: "Startup Ready", sub: "Perfil, pitch y capacidades IA completas", icon: "🏅" },
        { title: "Challenge Builder", sub: "Propuesta 30/60/90 enviada", icon: "🎯" },
        { title: "Finalist", sub: "Shortlist por votos, recomendaciones o jurado", icon: "🏆" },
        { title: "Pilot Ready", sub: "Reunión solicitada por agencia o marca", icon: "🤝" },
      ]},
    { icon: "🔎", title: "Agency Badges", tagline: "Para agencias que descubren soluciones para clientes.",
      items: [
        { title: "Agency Scout", sub: "Perfil de agencia validado", icon: "🔎" },
        { title: "Recommender", sub: "Recomienda startups con justificación", icon: "⭐" },
        { title: "Brief Builder", sub: "Publica retos o necesidades de cliente", icon: "🧾" },
        { title: "Top Connector", sub: "Genera reuniones calificadas", icon: "🤝" },
      ]},
    { icon: "🎯", title: "Brand Badges", tagline: "Para marcas que lanzan retos y buscan pilotos.",
      items: [
        { title: "Brand Explorer", sub: "Marca registrada y validada", icon: "👀" },
        { title: "Challenge Owner", sub: "Publica un reto de innovación", icon: "🎯" },
        { title: "Innovation Buyer", sub: "Solicita reuniones con startups", icon: "🛒" },
        { title: "Pilot Sponsor", sub: "Activa un piloto o selección formal", icon: "🚀" },
      ]},
    { icon: "🌐", title: "Ecosystem Badges", tagline: "Para hubs, aceleradoras, universidades y comunidades.",
      items: [
        { title: "Community Partner", sub: "Ecosistema verificado", icon: "🌐" },
        { title: "Talent Activator", sub: "Invita startups que completan perfil", icon: "📣" },
        { title: "Challenge Ally", sub: "Promueve retos y genera propuestas", icon: "🎯" },
        { title: "Ecosystem Champion", sub: "Top ranking por actividad útil", icon: "🏆" },
      ]},
  ];
